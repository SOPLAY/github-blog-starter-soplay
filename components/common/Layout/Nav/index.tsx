...
import { atomActiveNav } from './atom/atomActiveNav';
const Nav = () => {
  const [isActivMenu, setIsActivMenu] = useRecoilState(atomActiveNav);
  return (
    <div className='sticky top-0 h-screen overflow-y-auto bg-white shadow-[1px_1px_10px_rgba(0,0,0,.2)] dark:bg-dark-bg xl:w-64'>
      <div
